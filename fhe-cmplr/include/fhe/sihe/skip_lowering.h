...
#ifndef FHE_SIHE_SKIP_LOWERING_H
#define FHE_SIHE_SKIP_LOWERING_H

/**
 * @file skip_lowering.h
 * @brief Skip Lowering Registry for Selective Lowering in SIHE domain
 * 
 ...
 * 
 * IMPORTANT: The singleton is defined in skip_lowering.cxx (part of libFHEsihe).
 * All code linking against libFHEsihe shares the SAME singleton instance.
 * 
 * Usage:
 ...
 *   fhe_sihe.set_skip_ops(["fhe::sihe::bootstrap"])
 *   
 *   // In C++ handler:
 *   if (fhe::sihe::Should_skip_lowering("fhe::sihe", "bootstrap")) {
...
#endif  // FHE_SIHE_SKIP_LOWERING_H
