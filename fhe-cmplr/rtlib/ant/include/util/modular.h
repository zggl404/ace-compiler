...
#ifndef RTLIB_ANT_INCLUDE_UTIL_MODULAR_H
#define RTLIB_ANT_INCLUDE_UTIL_MODULAR_H
...
//! @brief Get precomputed barret for  1 << 128 / m->_val
...
//! @brief Barrett Modular Reduction (require:  0 <= val < mod_val^2)
...
//! @brief Fast modular multiplication with precomputed const
//! @param val1 value to be computed
//! @param val2 value to be computed
//! @param val2_inv precomputation for a multiplicand.
//! @param mod modulus of modular multiplication
//! @return int64_t
...
//! @brief Fused operation of sub and multiply const:
//! res = ((val1 - val2) * val3) % mod
//! @param val1 value to be substracted
//! @param val2 sustract value
//! @param val3 multiplied value(const)
//! @param val3_inv precompute value for val3
//! @param mod modulus value
//! @return result of fused operation: sub and multiply const
static inline int64_t Sub_mul_const_mod(uint64_t val1, uint64_t val2,
...
//! @brief Max 64 bit value used in 64 bit encoder
...
#endif
#endif  // RTLIB_ANT_INCLUDE_UTIL_MODULAR_H