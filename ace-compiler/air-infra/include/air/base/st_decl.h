...
typedef PTR<LITERAL>                 LITERAL_PTR;
typedef PTR_TO_CONST<LITERAL>        CONST_LITERAL_PTR;
...
typedef PTR_FROM_DATA<LITERAL_DATA>      LITERAL_DATA_PTR;
...
typedef ID_BASE<char*>         LITERAL_ID;
