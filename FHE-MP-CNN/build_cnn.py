...
# build command
build_seal=f'cmake -S {cnn}/cnn_ckks/cpu-ckks/single-key/seal-modified-3.6.6 -B {dir}/build_seal -DCMAKE_BUILD_TYPE=Release -DCMAKE_POLICY_VERSION_MINIMUM=3.5; \
