...
#ifndef NN_VECTOR_SKIP_LOWERING_H
#define NN_VECTOR_SKIP_LOWERING_H

/**
 * @file skip_lowering.h
 * @brief Skip Lowering Registry for Selective Lowering
 * 
 ...
 * 
 * IMPORTANT: The singleton is defined in skip_lowering.cxx (part of libNNvector).
 * All code linking against libNNvector shares the SAME singleton instance.
 * 
 * Usage:
 ...
 *   nn_addon.set_skip_ops(["nn::core::conv", "nn::core::matmul"])
 *   
 *   // In C++ handler:
 *   if (nn::vector::Should_skip_lowering("nn::core", "conv")) {
 *       return clone_node(visitor, node);  // Skip, let Python handle it
 *   }
 *   // ... normal C++ lowering
 */
...
#endif  // NN_VECTOR_SKIP_LOWERING_H
