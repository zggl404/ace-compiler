 ...
 * @brief Implementation of Skip Lowering Registry singleton
 * 
 * This file contains the ACTUAL singleton instance that is shared across
 * all code that links against libNNvector. The header (skip_lowering.h)
...
// Convenience function implementations that are exported from libNNvector
