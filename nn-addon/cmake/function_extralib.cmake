...
function (find_extralib_protobuf lib)
  ...
  if (Protobuf_FOUND)
    ...
    if (APPLE)
      ...
      if (AbslLogMessageLib)
        set (Protobuf_LIBRARIES ${Protobuf_LIBRARIES} ${AbslLogMessageLib})
      endif ()
      if (AbslLogCheckOpLib)
        set (Protobuf_LIBRARIES ${Protobuf_LIBRARIES} ${AbslLogCheckOpLib})
      endif ()
    else ()
