...
def ResNet18(num_classes=1000, channels=3):
    return ResNet(channels, ResBlock, [2, 2, 2, 2], useBottleneck=False, outputs=num_classes)

def ResNet34(num_classes=1000, channels=3):
    return ResNet(channels, ResBlock, [3, 4, 6, 3], useBottleneck=False, outputs=num_classes)

def ResNet50(num_classes=1000, channels=3):
    return ResNet(channels, ResBottleneckBlock, [3, 4, 6, 3], useBottleneck=True, outputs=num_classes)

def ResNet101(num_classes=1000, channels=3):
    return ResNet(channels, ResBottleneckBlock, [3, 4, 23, 3], useBottleneck=True, outputs=num_classes)

def ResNet152(num_classes=1000, channels=3):
    return ResNet(channels, ResBottleneckBlock, [3, 8, 36, 3], useBottleneck=True, outputs=num_classes)
