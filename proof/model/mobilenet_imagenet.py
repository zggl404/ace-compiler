...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate mobilenet_imagenet.onnx',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('-o', '--output', default='./mobilenet_imagenet.onnx', help='Setting the output path')
